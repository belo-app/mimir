...
What you usually would need to see in order to manage your account is balances, deposit addresses, contacts, transaction activity, prices and yields.
...
- [Get currencies](/v1#tag/currency)
- [Get profile settings](/v1/#tag/settings)
